...
<head>
    ...
    <noscript><img src="https://d5nxst8fruw4z.cloudfront.net/atrk.gif?account=s/NFo1IWx8107i" style="display:none" height="1" width="1" alt="header image" /></noscript>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>About Us</h1>
                        <hr class="small">
                        <span class="subheading" id="lh">
                            <a href="vision.php">Vision</a>
                            <a href="service.php">Worship Service</a>
                            <a href="beliefs.php">Beliefs</a>
                            <a class="underline" href="leaders.php">Elders & Deacons</a>
                        </span>
                    </div>
                </div>
            </div>
