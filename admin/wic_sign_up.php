...
<body style="min-height:1200px;">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">WIC Sign Up</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <?php include('php/list_wic_sign_up.php'); ?>
    ...
    $(".delete_wic").click(function(){
        var id = $(this).val();
        if(confirm('Are you sure you want to delete this WIC sign up?')){
            $.post('php/delete_wic.php', {"id" : id});
            window.location.href = "wic_sign_up.php";
        }
    });
