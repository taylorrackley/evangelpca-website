...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Weekly Bulletin</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <form role="form" method="post" action="php/upload_bulletin.php">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Date</label>
                                            <input class="form-control form_date" size="16" name="bulletin_date" value="<?php echo $date; ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">

                                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                                        <button type="submit" class="btn btn-default" name="submit">Submit Bulletin Changes</button>
                                        <button type="button" class="btn btn-danger" id="delete_bulletin">Delete Bulletin</button>
                                    </div>
                                </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
    ...
    $("#delete_bulletin").click(function(){
        if(confirm('Are you sure you want to delete this bulletin?')){
            $.post('php/delete_bulletin.php', {"id" : id});
            window.location.href = "bulletins.php";
        }
    });
