<?php
    ...
    if(!$_SESSION['logged_in'] || !$_SESSION['master']){
...
<body style="min-height:1200px;">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Website Admins</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <?php include('php/list_admins.php'); ?>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <form role="form" method="post" action="php/upload_admin.php">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <button type="submit" class="btn btn-default" name="submit">Create Admin</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    $(".delete_admin").click(function(){
        ...
        if(confirm('Are you sure you want to delete this Admin?'+id)){
            $.post('php/delete_admin.php', {"id" : id});
