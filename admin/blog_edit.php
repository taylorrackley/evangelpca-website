...
<body>
                            ...
                            <div class="row">
                                ...
                                <form role="form" method="post" action="php/upload_blog.php">
                                    <div class="col-lg-6">                                    
                                        ...
                                        <div class="form-group">
                                            <label>Author</label>
                                            <input class="form-control" name="author" value="<?php echo $author; ?>" required></input>
                                        </div>
                                        <div class="form-group">
                                            <label>Date</label>
                                            <input class="form-control form_date" size="16" name="post_date" value="<?php echo $date; ?>" readonly required>                                    
                                        </div>
                                        <div class="form-group">
                                            <label>Summary</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Post</label>
                                            <textarea class="form-control" name="post" rows="17" required><?php echo $post; ?></textarea>
                                        </div>          

                                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                                        <button type="submit" class="btn btn-default" name="submit">Submit Blog Changes</button>
                                        <button type="button" class="btn btn-danger" id="delete_blog">Delete Blog</button>
                                    </div>
                                </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
    ...
    $("#delete_blog").click(function(){
        if(confirm('Are you sure you want to delete this Blog?')){
            $.post('php/delete_blog.php', {"id" : id});
